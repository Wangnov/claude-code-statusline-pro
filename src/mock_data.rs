...
fn build_dev_scenario() -> InputData {
    ...
    input.session_id = Some("mock-dev-session".to_string());
    ...
    input.cost = Some(CostInfo {
        ...
        total_api_duration_ms: Some(4500),
...
fn build_critical_scenario() -> InputData {
    let mut input = InputData::default();
    input.session_id = Some("mock-critical-session".to_string());
    input.model = Some(ModelInfo {
    ...
    input.cost = Some(CostInfo {
        ...
        total_api_duration_ms: Some(52000),
...
fn build_thinking_scenario() -> InputData {
    let mut input = InputData::default();
    input.session_id = Some("mock-thinking-session".to_string());
    input.model = Some(ModelInfo {
        id: Some("claude-sonnet-4".to_string()),
        display_name: Some("Claude Sonnet 4".to_string()),
    });
...
fn build_complete_scenario() -> InputData {
    let mut input = InputData::default();
    input.session_id = Some("mock-complete-session".to_string());
    input.model = Some(ModelInfo {
        id: Some("claude-sonnet-4".to_string()),
        display_name: Some("Claude Sonnet 4".to_string()),
    });
...
fn build_error_scenario() -> InputData {
    let mut input = InputData::default();
    input.session_id = Some("mock-error-session".to_string());
    input.model = Some(ModelInfo {
